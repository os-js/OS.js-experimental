...
// I will have to rewrite this into something more usefull
(function() {
  ...
  function cmdCreateSurface(id, x, y, width, height, isTemp)
  {
    ...
    */
    ...
    if ( rootWindow ) {
      rootWindow._resizeTo(canvas.width, canvas.height, false, false, null, true);
    }
  ...
  */
  ...
  window.GTKBroadway = {
    connect: function(loc, el, win) {
      rootElement = el;
      rootWindow = win;
      console.info('Broadway connecting', loc);
